...
#ifndef MANGO_COMPAT_IPC_IPC_ENTRY_H
#define MANGO_COMPAT_IPC_IPC_ENTRY_H
...
/* Generation bits -- disabled in Mango (no port generations) */
...
#endif /* MANGO_COMPAT_IPC_IPC_ENTRY_H */
