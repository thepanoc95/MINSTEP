 ...
 * The implementation is in mango/ipc/ipc_hash.c (ported from osfmk).
 *
 * Original: osfmk/kernel/ipc/ipc_hash.h
 */

#ifndef MANGO_COMPAT_IPC_IPC_HASH_H
#define MANGO_COMPAT_IPC_IPC_HASH_H
...
#endif /* MANGO_COMPAT_IPC_IPC_HASH_H */
