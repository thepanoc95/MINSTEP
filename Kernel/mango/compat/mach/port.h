 ...
 * and ipc_space.
 *
 * PORT_GENERATIONS is disabled in Mango.  Port names are just
 * raw table indices with no generation counter.  This matches
 * IE_BITS_GEN_MASK == 0 in ipc_entry.h.
 */

#ifndef MANGO_COMPAT_MACH_PORT_H
#define MANGO_COMPAT_MACH_PORT_H
...
#endif /* MANGO_COMPAT_MACH_PORT_H */
