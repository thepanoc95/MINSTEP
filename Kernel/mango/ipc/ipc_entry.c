 ...
 *
 * Ported from osfmk/kernel/ipc/ipc_entry.c (Rich Draves, 1989).
 * Adapted for the Mango usermode nanokernel.
 *
 * Changes from original:
 *   - Removed MACH_KDB debug section
 *   - Removed MACH_IPC_COMPAT paths
 *   - Uses compat/ headers for kernel primitives
 *   - Converted K&R function definitions to ANSI style
 */
