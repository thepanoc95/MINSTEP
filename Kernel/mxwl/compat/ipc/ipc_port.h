/*
 * compat/ipc/ipc_port.h
 *
 * Usermode compatibility shim for Mach IPC port definitions.
 *
 * Original: osfmk/kernel/ipc/ipc_port.h
 * Stripped of NORMA_IPC, MACH_IPC_COMPAT, and MACH_KDB code paths.
 * Ported to Maxxwell usermode nanokernel.
 */

#ifndef MXWL_COMPAT_IPC_IPC_PORT_H
#define MXWL_COMPAT_IPC_IPC_PORT_H
...
ipc_port_dnrequest(ipc_port_t port, mach_port_t name, ipc_port_t soright,
...
extern ipc_port_t
ipc_port_dncancel(ipc_port_t port, mach_port_t name, ipc_port_request_index_t index);
...
extern void
ipc_port_set_seqno(ipc_port_t port, mach_port_seqno_t seqno);

extern void
ipc_port_clear_receiver(ipc_port_t port);

extern void
ipc_port_init(ipc_port_t port, ipc_space_t space, mach_port_t name);

extern kern_return_t
ipc_port_alloc(ipc_space_t space, mach_port_t *namep, ipc_port_t *portp);

extern kern_return_t
ipc_port_alloc_name(ipc_space_t space, mach_port_t name, ipc_port_t *portp);

extern void
ipc_port_destroy(ipc_port_t port);

extern boolean_t
ipc_port_check_circularity(ipc_port_t port, ipc_port_t dest);

extern ipc_port_t
ipc_port_lookup_notify(ipc_space_t space, mach_port_t name);

extern ipc_port_t
ipc_port_make_send(ipc_port_t port);

extern ipc_port_t
ipc_port_copy_send(ipc_port_t port);

extern mach_port_t
ipc_port_copyout_send(ipc_port_t sright, ipc_space_t space);

extern void
ipc_port_release_send(ipc_port_t port);

extern ipc_port_t
ipc_port_make_sonce(ipc_port_t port);

extern void
ipc_port_release_sonce(ipc_port_t port);

extern void
ipc_port_release_receive(ipc_port_t port);

extern ipc_port_t
ipc_port_alloc_special(ipc_space_t space);

extern void
ipc_port_dealloc_special(ipc_port_t port, ipc_space_t space);
...
#endif	/* MXWL_COMPAT_IPC_IPC_PORT_H */
