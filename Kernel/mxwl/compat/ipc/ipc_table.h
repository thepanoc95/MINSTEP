 ...
 * primitives.  In Maxxwell, we back these with malloc rather than the
 * kernel VM system.
 *
 * Original: osfmk/kernel/ipc/ipc_table.h
 */

#ifndef MXWL_COMPAT_IPC_IPC_TABLE_H
#define MXWL_COMPAT_IPC_IPC_TABLE_H
...
#endif /* MXWL_COMPAT_IPC_IPC_TABLE_H */
