#ifndef MXWL_COMPAT_IPC_IPC_THREAD_H
#define MXWL_COMPAT_IPC_IPC_THREAD_H
...
typedef struct mxwl_ipc_thread {
    struct mxwl_ipc_thread *ith_next;
    struct mxwl_ipc_thread *ith_prev;
