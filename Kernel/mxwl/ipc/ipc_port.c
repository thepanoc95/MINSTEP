 ...
 *
 *	Ported from Mach 4 (OpenMach/Utah CSL) to Maxxwell usermode nanokernel.
 *	Stripped of NORMA_IPC, MACH_IPC_COMPAT, and MACH_KDB code paths.
 *	Usermode adaptations: kalloc -> malloc, simple_lock -> pthread_mutex,
 *	zone allocator -> malloc-backed.
 */
