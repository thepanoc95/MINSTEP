...
typedef struct mach_msg_header {
    ...
    mach_msg_type_name_t msgh_voucher_port;  /* Voucher (always 0 in Maxxwell)  */
...
/* -----------------------------------------------------------------------
 *  Maxxwell IPC message structure
 *
 *  A complete Maxxwell IPC message.  The header is always present.
