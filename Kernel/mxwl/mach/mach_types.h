/*
 * mxwl/mach/mach_types.h
 *
 * Core Mach-compatible type definitions for the Maxxwell nanokernel.
 * These types mirror the real Mach kernel types so that code
 * written against Maxxwell can be retargeted at a real Mach kernel
 * with minimal changes.
 */

#ifndef MXWL_MACH_TYPES_H
#define MXWL_MACH_TYPES_H
